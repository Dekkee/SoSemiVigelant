...
const request = __webpack_require__(1),
    ...
    requirejs = __webpack_require__(3),
    localStorage = __webpack_require__(4).createLocalStorage({ mode: "node" });
...
module.exports = function (callback) {
    __webpack_require__(5).env('', function (err, window) {
        if (err) {
            console.error(err);
            return;
        }
        requirejs.define('jquery', [], () => __webpack_require__(6)(window))
...
module.exports = require("localstorage-ponyfill");
